...
public class UberLoggerAppWindow : MonoBehaviour, UberLogger.ILogger
{
    ...
    public Color GUIColour = new(1, 1, 1, 0.5f);

    //If non-zero, scales the fonts
    public int FontSize = 0;
    public Color SizerLineColour = new(42.0f / 255.0f, 42.0f / 255.0f, 42.0f / 255.0f);
    ...
    public Vector2 ButtonSize = new(32, 32);
    ...
    /// </summary>
    private bool ShouldShowLog(System.Text.RegularExpressions.Regex regex, LogInfo log)
    {
    ...
    public void DrawLogList()
    {
        ...
        float buttonY = 0;
        var buttonHeight = LogLineStyle1.CalcSize(new GUIContent("Test")).y;
        ...
        for (var c1 = 0; c1 < LogInfo.Count; c1++)
        {
            var log = LogInfo[c1];
